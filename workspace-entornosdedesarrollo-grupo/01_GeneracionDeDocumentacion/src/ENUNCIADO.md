# AE-1. Generación de documentación

### Requerimiento 1

Queremos documentar con JavaDoc una serie de clases que implementen una calculadora. Para ello hemos predefinido una serie de clases y métodos que el equipo tendrá que documentar. Nótese que NO hay que implementar el código, solo la declaración de los métodos y las clases y su documentación. Esta actividad está pensada para que cada miembro del equipo documente una clase.

<b> Clase 1: Suma. </b> Esta clase implementará todos los métodos que están relacionados con la sumas de la calculadora. Esta clase tendrá los siguientes métodos:
...
<b> Clase 2: Resta. </b> Esta clase implementará todos los métodos que están relacionados con la resta de la calculadora. Esta clase tendrá los siguientes métodos:
...
<b> Clase 3: Producto. </b> Esta clase implementará todos los métodos que están relacionados con la multiplicación de la calculadora. Esta clase tendrá los siguientes métodos:
...
<b> Clase 4: Cociente. </b> Esta clase implementará todos los métodos que están relacionados con la división de la calculadora. Esta clase tendrá los siguientes métodos:
...
Generar la documentación de JavaDoc mediante Eclipse o IDE equivalente.
...
Para la entrega, se subirá el código (archivos fuente) comprimido (zip o equivalente) a la plataforma con los ficheros de javadoc generados.
